    ...
    <div style={{ padding: 24 }}>
      ...
      {leaveBalance && (
        <Card title={t('attendance.leaveBalance')} style={{ marginBottom: 24 }} size="small">
          <Row gutter={24}>
            <Col><Statistic title={t('leave.annual')} value={leaveBalance.annual} suffix="天" valueStyle={{ color: '#52c41a' }} /></Col>
            <Col><Statistic title={t('leave.sick')} value={leaveBalance.sick} suffix="天" valueStyle={{ color: '#1890ff' }} /></Col>
            <Col><Statistic title={t('leave.personal')} value={leaveBalance.personal} suffix="天" valueStyle={{ color: '#faad14' }} /></Col>
          </Row>
        </Card>
      )}
