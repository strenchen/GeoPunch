    ...
    <div style={{ padding: 24 }}>
      ...
      {leaveBalance && (
        <Card title={t('attendance.leaveBalance')} style={{ marginBottom: 24 }} size="small">
          <Row gutter={24}>
            <Col><Statistic title={t('leave.annual')} value={leaveBalance.annual?.remaining ?? 0} suffix="天" valueStyle={{ color: '#52c41a' }} /></Col>
            <Col><Statistic title={t('leave.sick')} value={leaveBalance.sick?.remaining ?? 0} suffix="天" valueStyle={{ color: '#1890ff' }} /></Col>
            <Col><Statistic title={t('leave.personal')} value={leaveBalance.personal?.remaining ?? 0} suffix="天" valueStyle={{ color: '#faad14' }} /></Col>
          </Row>
        </Card>
      )}
